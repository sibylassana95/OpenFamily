...
export const renderNotificationEmail = (
    ...
    const bodyHtml = `
      ...
      <p style="margin:0;">
        <a href="${escapeHtml(ctaUrl)}" style="display:inline-block;background:#18181b;color:#ffffff;text-decoration:none;padding:10px 20px;border-radius:8px;font-size:14px;font-weight:600;">Voir dans KeurSIBY</a>
      </p>
    `;
