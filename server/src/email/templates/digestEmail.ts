...
export const renderDigestEmail = (
    ...
    const bodyHtml = `
      ...
      <p style="margin:24px 0 0 0;">
        <a href="${escapeHtml(baseUrl)}" style="display:inline-block;background:#18181b;color:#ffffff;text-decoration:none;padding:10px 20px;border-radius:8px;font-size:14px;font-weight:600;">Ouvrir KeurSIBY</a>
      </p>
    `;
    ...
    textLines.push(`Ouvrir KeurSIBY : ${baseUrl}`);
    textLines.push('');
