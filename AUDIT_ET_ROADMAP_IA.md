# KeurSIBY — Audit technique & Roadmap IA
...
- **CLI d'administration** : `keursiby-cli reset-password`, `create-admin`, `import`, `backup`, `migrate`. Aide énorme pour le self-host.
...
À l'issue de ces 3 sprints, KeurSIBY est passé de "app perso bien faite mais isolée" à "**plateforme familiale collaborative avec IA**" — positionnement difficilement copiable par Bring!, Cozi ou Tody dans l'année.
